...
namespace MyContacts
{
    ...
    internal class ContactsRepository : IContactsRepository
    {
        ...
        private string Contact_DBConnectionString = ("Data Source=SOROUSH\\MSQL2019;Initial Catalog=Contact_DB;Integrated Security=True");
        public bool Delete(int contactId)
        {
            SqlConnection connection = new SqlConnection(Contact_DBConnectionString);
            try
            {
        ...
        public bool Insert(string name, string family, string mobile, string email, int age, string address)
        {
            ...
            try
            {
                ...
                string querry = "Insert Into MyContacts(Name,Family,Email,Age,Mobile,Address) values (@Name,@Family,@Email,@Age,@Mobile,@Address)";
